...
<html><head>
	...
	<link rel="icon" href="gambar/admin/Frame_9.png">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-contao" aria-hidden="true"></i>X</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>Kebodeteksi 1.0</b></span>
        </a>
        <!-- Header Navbar -->
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2023 - Made with <i class="fa fa-heart pulse"></i> by <a href="https://github.com/exo12dyorama" target="_blank">Akmalakmal</a></div></strong>
      </footer>
